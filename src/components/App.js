...
const App = () => {
  ...
  return (
    <div>
      ...
      <button data-testid="prevButton" onclick="{prev}" disabled = { slide_no === 0 }>Prev</button>
      <button data-testid="nextButton" onclick="{next}" disabled = { slide_no === slides.length-1 }>Next</button>
    </div>
  )
}
